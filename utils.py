...
def generate_test_paths(
    ...
    segments = (
        segment_generator(random.randint(1, segment_amount))
        for _ in range(test_path_amount)
    )
...
Json = Union[Dict[str, "Json"], List["Json"], int, float, str, None]
